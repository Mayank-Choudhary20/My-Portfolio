        ...
        {!loading && filtered.length > 0 && (
          <div style={{ display: "grid", gap: "10px" }} className="project-grid">
            {filtered.map((project) => (
              <div key={project.id} style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "10px", overflow: "hidden", transition: "border-color 0.15s" }}
              ...
              >
                ...
                <div style={{ padding: "12px" }}>
                  ...
                  <p style={{ fontSize: "12px", color: "rgba(255,255,255,0.35)", marginBottom: "10px", overflow: "hidden", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" }}>{project.description}</p>
                  {project.imageUrl && (
                    <img
                  ...
                  <div style={{ display: "flex", gap: "6px", paddingTop: "8px", borderTop: "1px solid rgba(255,255,255,0.04)" }}>
                    <button onClick={() => openEdit(project)} style={{ display: "flex", alignItems: "center", gap: "4px", padding: "4px 8px", background: "rgba(255,255,255,0.04)", color: "rgba(255,255,255,0.5)", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "6px", fontSize: "11px", cursor: "pointer" }}>
                      <Pencil size={10} /> Edit
                    </button>
                    <button onClick={() => handleDelete(project)} style={{ display: "flex", alignItems: "center", gap: "4px", padding: "4px 8px", background: "rgba(239,68,68,0.05)", color: "#f87171", border: "1px solid rgba(239,68,68,0.12)", borderRadius: "6px", fontSize: "11px", cursor: "pointer" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
          ...
          <div>
            ...
            <input
              ...
              style={inp}
              value={form.title ?? ""}
              onChange={(e) => setForm((p) => ({ ...p, title: e.target.value, slug: editing ? p.slug : slugify(e.target.value) }))}
            />
          </div>
