...
// ── SAFE imports only from react-icons/si (verified v5 exports)
import {
  SiReact,
  SiNextdotjs,
  SiTypescript,
...
// ── Icon registry (100% verified exports) ─────────────────────
...
const getLevel = (level: string) =>
  LEVEL_DATA[level] ?? { percent: 50, label: level, color: "from-blue-400 to-cyan-400" };
    ...
    >
      ...
      >
        ...
        <div className="flex items-start justify-between">
          ...
          {/* Level badge */}
          <span
            className={`text-[10px] px-2 py-1 rounded-full font-semibold tracking-wide border ${
              lvl.percent >= 80
        ...
        <div className="mt-auto">
          ...
          <div className="h-1 rounded-full bg-white/5 overflow-hidden">
            <motion.div
              ...
              style={{
                boxShadow: hovered ? `0 0 8px ${cat.glow}` : undefined,
              }}
            />
          </div>
        </div>
          ...
          >
            {[
              ...
              },
              {
                ...
                value: skills.filter(
                  (s) =>
                    s.level.toUpperCase() === "ADVANCED" ||
                    s.level.toUpperCase() === "EXPERT"
                ).length,
                icon: Code2,
